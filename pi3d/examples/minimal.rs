...
fn main() {
    ...
    let shader = pi3d::shader::Program::from_res(&display, "uv_flat").unwrap();
    ...
    let mut plane = pi3d::shapes::plane::create(display.height * 0.7, display.height * 0.7);

...
void main(void) {
  ...
  float n1 = mix(unif[11][0], unif[15][0], mix_f); // lerp between left value and right value
  float m1 = mix(unif[11][1], unif[15][1], mix_f); 
  float ar1 = mix(unif[11][2], unif[15][2], mix_f); 
  float ai1 = mix(unif[12][0], unif[16][0], mix_f);
  float n2 = mix(unif[12][1], unif[16][1], mix_f); 
  float m2 = mix(unif[12][2], unif[16][2], mix_f); 
  float ar2 = mix(unif[13][0], unif[17][0], mix_f); 
  float ai2 = mix(unif[13][1], unif[17][1], mix_f);
  float n3 = mix(unif[13][2], unif[17][2], mix_f); 
  float m3 = mix(unif[14][0], unif[18][0], mix_f); 
  float ar3 = mix(unif[14][1], unif[18][1], mix_f); 
  float ai3 = mix(unif[14][2], unif[18][2], mix_f);
